...
package com.example.api_java.PokemonDetails;
...
class Other {
    ...
    public Home getOfficialArtwork() { return officialArtwork; }
    public void setOfficialArtwork(Home value) { this.officialArtwork = value; }
